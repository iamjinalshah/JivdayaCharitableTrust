<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Salary.aspx.cs" Inherits="Salary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="background-image: url('images1/con_bg.jpg'); font-family: Arial, Helvetica, sans-serif; font-size: x-large; color: #000000; height: 714px;">
       <div></div><div>
<div align="center" 
    ...
    <table style="width: 100%; margin-top: 30px; height: 488px;">
            ...
            <tr>
                ...
                <td class="style3">
                    <asp:DropDownList ID="ddlrollID" runat="server" 
                        Height="20px" Width="154px" style="margin-left: 3px">
            ...
            <tr>
                ...
                <td class="style3">
                    <asp:DropDownList ID="ddlName" runat="server" 
                        ...
                        Width="154px" style="margin-left: 2px">
