<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ErrorPage.aspx.cs" Inherits="AdminPanel_ErrorPage" %>
...
<body>
    ...
    <p class="error-code">
		...
		<div class="content">
			...
			<br/><a href="AdminHome.aspx">Go Home</a> or<br/><form>Search<br/><input autofocus type="text" name="search" /></form>
		</div>
    </div>
