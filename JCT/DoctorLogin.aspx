...
<!-- start centerbody-->
	<div class="center">
		<div class="leftpanel">
			<div class="left_title">Doctor Login<br />
                <br />
                <br />
                <br />
            </div>
           ...
           <asp:TextBox ID="txt_Password" runat="server" class="userbox" TextMode="Password"></asp:TextBox>
				...
				<div>
					<a href="DoctorForgetPassword.aspx" class="forgot_text">Forgot Password?</a>
				    <a href="DoctorRegistration.aspx" class="sign_text">New User? Sign Up</a>
				  <div class="clr">
...
<map name="Map3" id="Map3"><area shape="rect" coords="112,52,232,86" href="#" alt="" /></map></div>
		...
		<div class="centerpanel">
			<div class="center_title">Welcome to Doctor<span class="center_title_color" 
                    style="color: #FF0000"> of The Jivdaya Charitable Trust</span></div>
