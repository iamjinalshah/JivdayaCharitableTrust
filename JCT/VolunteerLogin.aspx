...
<!-- start centerbody-->
	<div class="center">
		<div class="leftpanel">
			<div class="left_title">Volunteer Login<br />
                <br />
                <br />
                <br />
            </div>
           ...
           <asp:TextBox ID="txt_Password" runat="server" class="userbox" TextMode="Password"></asp:TextBox>
				...
				<div>
					<a href="VolunteerForgetPassword.aspx" class="forgot_text">Forgot Password?</a>
				    <a href="Volunteer_Registration.aspx" class="sign_text">New User? Sign Up</a>
				  <div class="clr">
				...
				<div>
					...
					<div class="login">
                        <asp:ImageButton ID="ImageButton1" runat="server" 
                            ImageUrl="~/images1/loginbtn.png" onclick="ImageButton1_Click" />
                    </div>
...
<map name="Map3" id="Map3"><area shape="rect" coords="112,52,232,86" href="#" alt="" /></map></div>
		...
		<div class="centerpanel">
			<div class="center_title">Volunteer of&nbsp; <span class="center_title_color" 
                    style="color: #FF0000">Jivdaya Charitable Trust</span></div>
